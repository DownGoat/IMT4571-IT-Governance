...
\pagestyle{fancy} % Print headers again
 ...
 \chapter{Information Security Policy and Scope}
 \input{chap_5}

 %----------------------------------------------------------------------------------------
 %   CHAPTER 6
 %----------------------------------------------------------------------------------------
 \chapterimage{chap6.jpg} % Chapter heading image

 \chapter{The Risk Assesment and Statement of Applicabilitiy}
 \input{chap_6}
